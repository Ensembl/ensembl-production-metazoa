...
my $json_file_name = "${species_core}.wiki.json";
my $json_file_path = `ls -1 ${wiki_input_dir}/${json_file_name}`;
...
print DARK GREEN "Beginning processing RefSeq annotation:\n[$genome_sum_file] genome JSON\n";
	...
	my ($refseq_file, $gca_accession, $core_prodname_gca, $gca_accession_escape);
